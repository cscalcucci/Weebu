...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if(self){
        ...
        self.pageControl.currentPageIndicatorTintColor = [UIColor mintGreenColor];
        ...
        self.doneButton.backgroundColor = [UIColor peonyColor];
        self.doneButton.layer.borderColor = [UIColor peonyColor].CGColor;
